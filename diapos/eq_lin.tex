...
\begin{document}
	...
	\begin{itemize}
	\item Questions?
	\item Système d'équations linéaires et solution
	\item Opération élémentaire sur les lignes
	\item Forme matricielle et matrice augmentée
	\item Solution à partir de la matrice augmentée
	\item Exemple plus complexe
	\item Exemple avec la calculatrice en ligne
	\end{itemize}
\end{frame}	
...
\end{frame}
	...
	\begin{frame}{2. Remplacement - autre exemple}
	On remplace une ligne donnée par l'addition de celle-ci avec le multiple
	d'une autre ligne.	\begin{example}
		...
		\[
		{{\color{red}L_1} + L_2 \rightarrow \color{red}L_1}  \qquad \Rightarrow \qquad
		\left\{
		\begin{matrix}
		    x&+&2y&=& 4 \\
		    x&-&y &=& 1
    ...
    \begin{frame}{Rappel: Égalité de matrices\footnote{On a deux matrices $2\times1$. (Ce sont des vecteurs.)}}
		\[
\begin{pmatrix}
x + 2y\\
x - y
...
\begin{itemize}
	\item on fait au maximum une seule transformation pour une ligne donnée;
